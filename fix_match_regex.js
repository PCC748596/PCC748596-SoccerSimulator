...
const regex = /\{\s+if \(this\.gkHoldingBall\) this\.gkHoldingBall\[d\.team\] = false;\s+\}\);\s+\};\s+jog\.buildOutTimer = 5\.0;\s+\};\s+aplicar\(outroCB, -3\);\s+aplicar\(mesmoLado, 3\);\s+aplicar\(ladoOposto, 5\);\s+\}\);/;
